...
const skillsData = [
    ...
    { name: "C#", percentage: 70, category: "programmierung" },
    { name: "Python", percentage: 45, category: "programmierung" },
    { name: "JavaScript", percentage: 65, category: "programmierung" },
    { name: "HTML/CSS", percentage: 75, category: "web" },
    { name: "React", percentage: 40, category: "web" },
    { name: "Node.js", percentage: 35, category: "web" },
    { name: "SQL", percentage: 90, category: "datenbank" },
    { name: "MySQL", percentage: 85, category: "datenbank" },
    { name: "PostgreSQL", percentage: 70, category: "datenbank" },
    { name: "MongoDB", percentage: 30, category: "datenbank" },
    { name: "SPS-Programmierung", percentage: 100, category: "automation" },
    { name: "Siemens TIA Portal", percentage: 95, category: "automation" },
    { name: "Schneider Unity Pro", percentage: 80, category: "automation" },
    { name: "HMI-Entwicklung", percentage: 85, category: "automation" },
    { name: "Git", percentage: 80, category: "tools" },
    { name: "Docker", percentage: 25, category: "tools" },
    { name: "Visual Studio", percentage: 85, category: "tools" },
    { name: "IntelliJ IDEA", percentage: 75, category: "tools" },
    { name: "REST APIs", percentage: 60, category: "web" },
    { name: "JSON/XML", percentage: 90, category: "web" },
    { name: "SCADA-Systeme", percentage: 70, category: "automation" },
    { name: "Profinet/Profibus", percentage: 85, category: "automation" }
];
